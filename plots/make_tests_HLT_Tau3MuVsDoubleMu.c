{
   ...
   draw_branches({"tau_mu12_fitM","tau_mu12_fitM"},  {"Run3_HLT_DoubleMu","Run3_HLT_Tau3Mu"}, "M(#mu_{1},#mu_{2}) (GeV)", 80, 0., 2.0, "HLTcomp_Mu12mass");
   draw_branches({"tau_mu13_fitM","tau_mu13_fitM"},  {"Run3_HLT_DoubleMu","Run3_HLT_Tau3Mu"}, "M(#mu_{1},#mu_{3}) (GeV)", 80, 0., 2.0, "HLTcomp_Mu13mass");
   draw_branches({"tau_mu23_fitM","tau_mu23_fitM"},  {"Run3_HLT_DoubleMu","Run3_HLT_Tau3Mu"}, "M(#mu_{2},#mu_{3}) (GeV)", 80, 0., 2.0, "HLTcomp_Mu23mass");
   // DR mu-tau
   ...
   draw_branches({"tau_fit_mass_resol","tau_fit_mass_resol"},  {"Run3_HLT_DoubleMu","Run3_HLT_Tau3Mu"}, "#sigma/M(3 #mu)", 50, 0., 0.025, "HLTcomp_fitTauMass_resol");
