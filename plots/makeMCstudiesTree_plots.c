{
   ...
   SetIO("../outRoot/WTau3Mu_MCanalyzer_2022_HLT_overlap_onTau3Mu.root", "WTau3Mu_tree", "/eos/user/c/cbasile/www/Tau3Mu_Run3/MCstudies/2022/WTau3Mu/");
   ...
   draw_one_histo("tau_fit_mass", "tau_fit", "M(3#mu) (GeV)", 40, 1.6, 2.0, "tau_fit_M");
   draw_one_histo("tau_fit_pt", "tau_fit", "p_{T}(3#mu) (GeV)", 40, 10, 100, "tau_fit_pT");
   draw_one_histo("tau_fit_eta", "tau_fit", "#eta (3#mu)", 35, -3.5, 3.5, "tau_fit_eta");
   ...
   // MET vs PU
   ProfileVsPU({"fabs(tau_met_pt-gen_met_pt)/gen_met_pt", "fabs(tau_DeepMet_pt-gen_met_pt)/gen_met_pt", "fabs(tau_rawMet_pt-gen_met_pt)/gen_met_pt"},{"PuppiMET", "DeepMET", "rawPuppiMET"}, "# PV", "|MET^{reco}-MET^{gen}|/MET^{gen}", 14, 0, 70, 0, 1.2, "diff_GenMET_vs_PU"); 
