{
   ...
   draw_branches({"tau_mu12_fitM","tau_mu12_fitM"},            {cat_1,cat_2}, "M(#mu_{1},#mu_{2}) (GeV)", 20, 0., 2.0, out_tag + "_Mu12mass");
   draw_branches({"tau_mu13_fitM","tau_mu13_fitM"},            {cat_1,cat_2}, "M(#mu_{1},#mu_{3}) (GeV)", 20, 0., 2.0, out_tag + "_Mu13mass");
   draw_branches({"tau_mu23_fitM","tau_mu23_fitM"},            {cat_1,cat_2}, "M(#mu_{2},#mu_{3}) (GeV)", 20, 0., 2.0, out_tag + "_Mu23mass");
   // DR mu-tau
   ...
   draw_branches({"tau_relIso*tau_fit_pt", "tau_relIso*tau_fit_pt"},{cat_1,cat_2}, "abs isolation (3 #mu)", 20, 0, 20.0, out_tag + "_Tau_absIso", true);
   ...
   draw_branches({"tau_met_phi", "tau_met_phi" },              {cat_1,cat_2}, " #phi (MET) ", 32, -3.2, 3.2, out_tag + "_phi_PuppiMET");
   draw_branches({"tau_met_ratio_pt", "tau_met_ratio_pt"},     {cat_1,cat_2}, " p_{T}^{3 #mu}/p_{T}^{MET} ", 50, 0., 4., out_tag + "_pTratio_PuppiMET");
   draw_branches({"miss_pz_min", "miss_pz_min"},               {cat_1,cat_2}, " min p_{z}^{#nu} (GeV)", 100, -300., 300., out_tag + "_miss_pz_min");
   draw_branches({"miss_pz_max", "miss_pz_max"},               {cat_1,cat_2}, " max p_{z}^{#nu} (GeV)", 100, -1000., 1000., out_tag + "_miss_pz_max");
