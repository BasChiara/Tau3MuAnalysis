{
   ...
   SetSelection( {"","1*(weight)"});
   TString cat_1 = "MCno_weight";
   TString cat_2 = "MC_weight";
   TString out_tag = "FULLweight";
   SetOutputFile("/eos/user/c/cbasile/www/Tau3Mu_Run3/MCstudies/2022preEE/SF_impact/");
   ...
   draw_branches({"tau_met_phi", "tau_met_phi" },              {cat_1,cat_2}, " #phi (MET) ", 35, -3.5, 3.5, out_tag + "_phi_PuppiMET");
