{
   ...
   bool is_MC = false;
   TString HLT_DoubleMu_plus = "(tau_fit_pt > 10.0) && (tau_relIso < 0.2) && (tau_mu3_pt > 1.0) && (tau_mu12_fitM < 1.9 && tau_mu12_dZ < 0.7) && (tau_mu13_fitM < 1.9 && tau_mu13_dZ < 0.7) && (tau_mu23_fitM < 1.9 && tau_mu23_dZ < 0.7)";
   if(is_MC) {
      ...
      SetSelection( {HLT_DoubleMu_plus, ""});
   ...
   //draw_branches({"tau_mu12_dZ", "tau_mu12_dZ"}, {"Run3_HLT_DoubleMu","Run3_HLT_Tau3Mu"},"#Delta z(#mu_{1}, #mu_{2}) (cm)", 30, 0., 3., "HLTcomp_tau_mu12_dZ", true);
   //draw_branches({"tau_mu23_dZ", "tau_mu23_dZ"}, {"Run3_HLT_DoubleMu","Run3_HLT_Tau3Mu"},"#Delta z(#mu_{2}, #mu_{3}) (cm)", 30, 0., 3., "HLTcomp_tau_mu23_dZ", true);
   //draw_branches({"tau_mu13_dZ", "tau_mu13_dZ"}, {"Run3_HLT_DoubleMu","Run3_HLT_Tau3Mu"},"#Delta z(#mu_{1}, #mu_{3}) (cm)", 30, 0., 3., "HLTcomp_tau_mu13_dZ", true);
   //draw_branches({"tau_mu12_fitM","tau_mu12_fitM"},  {"Run3_HLT_DoubleMu","Run3_HLT_Tau3Mu"}, "M(#mu_{1},#mu_{2}) (GeV)", 80, 0.5, 5.0, "HLTcomp_Mu12mass");
   //draw_branches({"tau_mu13_fitM","tau_mu13_fitM"},  {"Run3_HLT_DoubleMu","Run3_HLT_Tau3Mu"}, "M(#mu_{1},#mu_{3}) (GeV)", 80, 0.5, 5.0, "HLTcomp_Mu13mass");
   //draw_branches({"tau_mu23_fitM","tau_mu23_fitM"},  {"Run3_HLT_DoubleMu","Run3_HLT_Tau3Mu"}, "M(#mu_{2},#mu_{3}) (GeV)", 80, 0.5, 5.0, "HLTcomp_Mu23mass");
   //// DR mu-tau
   ...
   //
   //// Tau
   //draw_branches({"tau_fit_mass","tau_fit_mass"},  {"Run3_HLT_DoubleMu","Run3_HLT_Tau3Mu"}, "M(3 #mu) (GeV)", 120, 1.6, 4.0, "HLTcomp_fitTauMass");
   ...
   //draw_branches({"tau_fit_vprob","tau_fit_vprob"},    {"Run3_HLT_DoubleMu","Run3_HLT_Tau3Mu"}, "vtx-probability(3 #mu)", 40, 0., 1., "HLTcomp_Tau_Vprob");
   ...
   //// W
   draw_branches({"W_pt","W_pt"}, {"Run3_HLT_DoubleMu","Run3_HLT_Tau3Mu"}, "W p_{T} (GeV)", 50, 0.0, 150.0, "HLTcomp_WpT_rIso0p2");
