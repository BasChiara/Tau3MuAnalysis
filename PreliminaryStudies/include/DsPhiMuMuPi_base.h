...
// Sat Jan 20 23:53:17 2024 by ROOT version 6.26/11
// from TTree Events/Events
// found on file: /eos/cms/store/group/phys_bphys/cbasile/DsPhiMuMuPiNano_2024Jan19/DstoPhiPi_Phito2Mu_MuFilter_TuneCP5_13p6TeV_pythia8-evtgen/crab_DstoPhiPi_2022/240119_143409/0000/DsPhiMuMuPiNANO_mc_2024Jan19_10.root
//////////////////////////////////////////////////////////

#ifndef DsPhiMuMuPi_base_h
#define DsPhiMuMuPi_base_h
...
// Fixed size dimensions of array or collections stored in the TTree if any.
   ...
   Int_t           nDsPhiPi;
   Int_t           DsPhiPi_charge[20];   //[nDsPhiPi]
   Int_t           DsPhiPi_diMuVtxFit_toVeto[20];   //[nDsPhiPi]
   Int_t           DsPhiPi_fired_Tau3Mu_Mu7_Mu1_TkMu1_IsoTau15[20];   //[nDsPhiPi]
   Int_t           DsPhiPi_fired_Tau3Mu_Mu7_Mu1_TkMu1_IsoTau15_Charge1[20];   //[nDsPhiPi]
   Int_t           DsPhiPi_mu1_charge[20];   //[nDsPhiPi]
   Int_t           DsPhiPi_mu1_fired_DoubleMu4_3_LowMass[20];   //[nDsPhiPi]
   Int_t           DsPhiPi_mu1_fired_Tau3Mu_Mu7_Mu1_TkMu1_IsoTau15[20];   //[nDsPhiPi]
   Int_t           DsPhiPi_mu1_fired_Tau3Mu_Mu7_Mu1_TkMu1_IsoTau15_Charge1[20];   //[nDsPhiPi]
   Int_t           DsPhiPi_mu1_idx[20];   //[nDsPhiPi]
   Int_t           DsPhiPi_mu1_trackQuality[20];   //[nDsPhiPi]
   Int_t           DsPhiPi_mu2_charge[20];   //[nDsPhiPi]
   Int_t           DsPhiPi_mu2_fired_DoubleMu4_3_LowMass[20];   //[nDsPhiPi]
   Int_t           DsPhiPi_mu2_fired_Tau3Mu_Mu7_Mu1_TkMu1_IsoTau15[20];   //[nDsPhiPi]
   Int_t           DsPhiPi_mu2_fired_Tau3Mu_Mu7_Mu1_TkMu1_IsoTau15_Charge1[20];   //[nDsPhiPi]
   Int_t           DsPhiPi_mu2_idx[20];   //[nDsPhiPi]
   Int_t           DsPhiPi_mu2_trackQuality[20];   //[nDsPhiPi]
   Int_t           DsPhiPi_trk_charge[20];   //[nDsPhiPi]
   Int_t           DsPhiPi_trk_fired_DoubleMu4_3_LowMass[20];   //[nDsPhiPi]
   Int_t           DsPhiPi_trk_fired_Tau3Mu_Mu7_Mu1_TkMu1_IsoTau15[20];   //[nDsPhiPi]
   Int_t           DsPhiPi_trk_fired_Tau3Mu_Mu7_Mu1_TkMu1_IsoTau15_Charge1[20];   //[nDsPhiPi]
   Int_t           DsPhiPi_trk_idx[20];   //[nDsPhiPi]
   Int_t           DsPhiPi_trk_trackQuality[20];   //[nDsPhiPi]
   Int_t           DsPhiPi_vtx_isValid[20];   //[nDsPhiPi]
   Float_t         DsPhiPi_CosAlpha2D_LxyP3mu[20];   //[nDsPhiPi]
   Float_t         DsPhiPi_Lxy_3muVtxBS[20];   //[nDsPhiPi]
   Float_t         DsPhiPi_MuMu_fitted_eta[20];   //[nDsPhiPi]
   Float_t         DsPhiPi_MuMu_fitted_mass[20];   //[nDsPhiPi]
   Float_t         DsPhiPi_MuMu_fitted_mass_err2[20];   //[nDsPhiPi]
   Float_t         DsPhiPi_MuMu_fitted_phi[20];   //[nDsPhiPi]
   Float_t         DsPhiPi_MuMu_fitted_pt[20];   //[nDsPhiPi]
   Float_t         DsPhiPi_MuMu_fitted_vtxEx[20];   //[nDsPhiPi]
   Float_t         DsPhiPi_MuMu_fitted_vtxEy[20];   //[nDsPhiPi]
   Float_t         DsPhiPi_MuMu_fitted_vtxEz[20];   //[nDsPhiPi]
   Float_t         DsPhiPi_MuMu_fitted_vtxX[20];   //[nDsPhiPi]
   Float_t         DsPhiPi_MuMu_fitted_vtxY[20];   //[nDsPhiPi]
   Float_t         DsPhiPi_MuMu_fitted_vtxZ[20];   //[nDsPhiPi]
   Float_t         DsPhiPi_PV_x[20];   //[nDsPhiPi]
   Float_t         DsPhiPi_PV_y[20];   //[nDsPhiPi]
   Float_t         DsPhiPi_PV_z[20];   //[nDsPhiPi]
   Float_t         DsPhiPi_PVrefit_chi2[20];   //[nDsPhiPi]
   Float_t         DsPhiPi_PVrefit_isValid[20];   //[nDsPhiPi]
   Float_t         DsPhiPi_PVrefit_ndof[20];   //[nDsPhiPi]
   Float_t         DsPhiPi_PVrefit_x[20];   //[nDsPhiPi]
   Float_t         DsPhiPi_PVrefit_y[20];   //[nDsPhiPi]
   Float_t         DsPhiPi_PVrefit_z[20];   //[nDsPhiPi]
   Float_t         DsPhiPi_Tau3Mu_Mu7_Mu1_TkMu1_IsoTau15_Charge1_dr[20];   //[nDsPhiPi]
   Float_t         DsPhiPi_Tau3Mu_Mu7_Mu1_TkMu1_IsoTau15_dr[20];   //[nDsPhiPi]
   Float_t         DsPhiPi_absIsolation[20];   //[nDsPhiPi]
   Float_t         DsPhiPi_absIsolation_pT05[20];   //[nDsPhiPi]
   Float_t         DsPhiPi_dZmu12[20];   //[nDsPhiPi]
   Float_t         DsPhiPi_dZmu13[20];   //[nDsPhiPi]
   Float_t         DsPhiPi_dZmu23[20];   //[nDsPhiPi]
   Float_t         DsPhiPi_errLxy_3muVtxBS[20];   //[nDsPhiPi]
   Float_t         DsPhiPi_fitted_eta[20];   //[nDsPhiPi]
   Float_t         DsPhiPi_fitted_mass[20];   //[nDsPhiPi]
   Float_t         DsPhiPi_fitted_mass_err2[20];   //[nDsPhiPi]
   Float_t         DsPhiPi_fitted_phi[20];   //[nDsPhiPi]
   Float_t         DsPhiPi_fitted_pt[20];   //[nDsPhiPi]
   Float_t         DsPhiPi_iso_ptChargedForHLT[20];   //[nDsPhiPi]
   Float_t         DsPhiPi_iso_ptChargedForHLT_pT05[20];   //[nDsPhiPi]
   Float_t         DsPhiPi_iso_ptChargedFromPU[20];   //[nDsPhiPi]
   Float_t         DsPhiPi_iso_ptChargedFromPU_pT05[20];   //[nDsPhiPi]
   Float_t         DsPhiPi_iso_ptChargedFromPV[20];   //[nDsPhiPi]
   Float_t         DsPhiPi_iso_ptChargedFromPV_pT05[20];   //[nDsPhiPi]
   Float_t         DsPhiPi_iso_ptPhotons[20];   //[nDsPhiPi]
   Float_t         DsPhiPi_iso_ptPhotons_pT05[20];   //[nDsPhiPi]
   Float_t         DsPhiPi_mu12_DCA[20];   //[nDsPhiPi]
   Float_t         DsPhiPi_mu13_DCA[20];   //[nDsPhiPi]
   Float_t         DsPhiPi_mu1_dr[20];   //[nDsPhiPi]
   Float_t         DsPhiPi_mu1_eta[20];   //[nDsPhiPi]
   Float_t         DsPhiPi_mu1_phi[20];   //[nDsPhiPi]
   Float_t         DsPhiPi_mu1_pt[20];   //[nDsPhiPi]
   Float_t         DsPhiPi_mu23_DCA[20];   //[nDsPhiPi]
   Float_t         DsPhiPi_mu2_dr[20];   //[nDsPhiPi]
   Float_t         DsPhiPi_mu2_eta[20];   //[nDsPhiPi]
   Float_t         DsPhiPi_mu2_phi[20];   //[nDsPhiPi]
   Float_t         DsPhiPi_mu2_pt[20];   //[nDsPhiPi]
   Float_t         DsPhiPi_sigLxy_3muVtxBS[20];   //[nDsPhiPi]
   Float_t         DsPhiPi_trk_dr[20];   //[nDsPhiPi]
   Float_t         DsPhiPi_trk_eta[20];   //[nDsPhiPi]
   Float_t         DsPhiPi_trk_phi[20];   //[nDsPhiPi]
   Float_t         DsPhiPi_trk_pt[20];   //[nDsPhiPi]
   Float_t         DsPhiPi_vtx_Ndof[20];   //[nDsPhiPi]
   Float_t         DsPhiPi_vtx_chi2[20];   //[nDsPhiPi]
   Float_t         DsPhiPi_vtx_prob[20];   //[nDsPhiPi]
   Int_t           nDsPlusMET;
   Int_t           DsPlusMET_Flag_BadPFMuonDzFilter[20];   //[nDsPlusMET]
   Int_t           DsPlusMET_Flag_BadPFMuonFilter[20];   //[nDsPlusMET]
   Int_t           DsPlusMET_Flag_EcalDeadCellTriggerPrimitiveFilter[20];   //[nDsPlusMET]
   Int_t           DsPlusMET_Flag_eeBadScFilter[20];   //[nDsPlusMET]
   Int_t           DsPlusMET_Flag_globalSuperTightHalo2016Filter[20];   //[nDsPlusMET]
   Int_t           DsPlusMET_Flag_goodVertices[20];   //[nDsPlusMET]
   Int_t           DsPlusMET_Flag_hfNoisyHitsFilter[20];   //[nDsPlusMET]
   Int_t           DsPlusMET_charge[20];   //[nDsPlusMET]
   Float_t         DsPlusMET_DeepMET_pt[20];   //[nDsPlusMET]
   Float_t         DsPlusMET_DeepMETmaxPz[20];   //[nDsPlusMET]
   Float_t         DsPlusMET_DeepMETminPz[20];   //[nDsPlusMET]
   Float_t         DsPlusMET_Deep_eta_max[20];   //[nDsPlusMET]
   Float_t         DsPlusMET_Deep_eta_min[20];   //[nDsPlusMET]
   Float_t         DsPlusMET_Deep_mass_max[20];   //[nDsPlusMET]
   Float_t         DsPlusMET_Deep_mass_min[20];   //[nDsPlusMET]
   Float_t         DsPlusMET_Deep_phi[20];   //[nDsPlusMET]
   Float_t         DsPlusMET_Deep_pt[20];   //[nDsPlusMET]
   Float_t         DsPlusMET_MET_pt[20];   //[nDsPlusMET]
   Float_t         DsPlusMET_METmaxPz[20];   //[nDsPlusMET]
   Float_t         DsPlusMET_METminPz[20];   //[nDsPlusMET]
   Float_t         DsPlusMET_PuppiMET_pt[20];   //[nDsPlusMET]
   Float_t         DsPlusMET_PuppiMETmaxPz[20];   //[nDsPlusMET]
   Float_t         DsPlusMET_PuppiMETminPz[20];   //[nDsPlusMET]
   Float_t         DsPlusMET_Puppi_eta_max[20];   //[nDsPlusMET]
   Float_t         DsPlusMET_Puppi_eta_min[20];   //[nDsPlusMET]
   Float_t         DsPlusMET_Puppi_mass_max[20];   //[nDsPlusMET]
   Float_t         DsPlusMET_Puppi_mass_min[20];   //[nDsPlusMET]
   Float_t         DsPlusMET_Puppi_phi[20];   //[nDsPlusMET]
   Float_t         DsPlusMET_Puppi_pt[20];   //[nDsPlusMET]
   Float_t         DsPlusMET_Tau_Deep_mT[20];   //[nDsPlusMET]
   Float_t         DsPlusMET_Tau_Puppi_mT[20];   //[nDsPlusMET]
   Float_t         DsPlusMET_Tau_mT[20];   //[nDsPlusMET]
   Float_t         DsPlusMET_eta_max[20];   //[nDsPlusMET]
   Float_t         DsPlusMET_eta_min[20];   //[nDsPlusMET]
   Float_t         DsPlusMET_mass_max[20];   //[nDsPlusMET]
   Float_t         DsPlusMET_mass_min[20];   //[nDsPlusMET]
   Float_t         DsPlusMET_mass_nominal[20];   //[nDsPlusMET]
   Float_t         DsPlusMET_phi[20];   //[nDsPlusMET]
   Float_t         DsPlusMET_pt[20];   //[nDsPlusMET]
   ...
   Int_t           nGenPart;
   Short_t         GenPart_genPartIdxMother[500];   //[nGenPart]
   UShort_t        GenPart_statusFlags[500];   //[nGenPart]
   ...
   DsPhiMuMuPi_base(TTree *tree=0, const bool &isMC=true);
   virtual ~DsPhiMuMuPi_base();
...
#ifdef DsPhiMuMuPi_base_cxx
DsPhiMuMuPi_base::DsPhiMuMuPi_base(TTree *tree, const bool& isMC) : fChain(0) 
{
// if parameter tree is not specified (or zero), connect the file
// used to generate this class and read the Tree.
   if (tree == 0) {
      TFile *f = (TFile*)gROOT->GetListOfFiles()->FindObject("/eos/cms/store/group/phys_bphys/cbasile/DsPhiMuMuPiNano_2024Jan19/DstoPhiPi_Phito2Mu_MuFilter_TuneCP5_13p6TeV_pythia8-evtgen/crab_DstoPhiPi_2022/240119_143409/0000/DsPhiMuMuPiNANO_mc_2024Jan19_10.root");
      if (!f || !f->IsOpen()) {
         f = new TFile("/eos/cms/store/group/phys_bphys/cbasile/DsPhiMuMuPiNano_2024Jan19/DstoPhiPi_Phito2Mu_MuFilter_TuneCP5_13p6TeV_pythia8-evtgen/crab_DstoPhiPi_2022/240119_143409/0000/DsPhiMuMuPiNANO_mc_2024Jan19_10.root");
      }
...
DsPhiMuMuPi_base::~DsPhiMuMuPi_base()
{
   if (!fChain) return;
   delete fChain->GetCurrentFile();
}

Int_t DsPhiMuMuPi_base::GetEntry(Long64_t entry)
{
// Read contents of entry.
   if (!fChain) return 0;
   return fChain->GetEntry(entry);
}
Long64_t DsPhiMuMuPi_base::LoadTree(Long64_t entry)
{
...
void DsPhiMuMuPi_base::Init(TTree *tree, const bool& isMC)
{
...
Bool_t DsPhiMuMuPi_base::Notify()
{
...
void DsPhiMuMuPi_base::Show(Long64_t entry)
{
...
Int_t DsPhiMuMuPi_base::Cut(Long64_t entry)
{
...
#endif // #ifdef DsPhiMuMuPi_base_cxx
