...
// Wed Dec 13 12:29:15 2023 by ROOT version 6.30/00
// from TTree Events/Events
// found on file: root://xrootd-cms.infn.it//store/user/crovelli/ParkingDoubleMuonLowMass0/crab_data_Run2022Fv1_0/231212_221018/0000/tau3muNANO_data_2023Dec12_19.root
//////////////////////////////////////////////////////////
...
// Fixed size dimensions of array or collections stored in the TTree if any.
   ...
   Float_t         TauTo3Mu_Lxy_3muVtxBS[10];   //[nTauTo3Mu]
   Float_t         TauTo3Mu_PV_x[10];   //[nTauTo3Mu]
   Float_t         TauTo3Mu_PV_y[10];   //[nTauTo3Mu]
   Float_t         TauTo3Mu_PV_z[10];   //[nTauTo3Mu]
   Float_t         TauTo3Mu_PVrefit_chi2[10];   //[nTauTo3Mu]
   Float_t         TauTo3Mu_PVrefit_isValid[10];   //[nTauTo3Mu]
   Float_t         TauTo3Mu_PVrefit_ndof[10];   //[nTauTo3Mu]
   Float_t         TauTo3Mu_PVrefit_x[10];   //[nTauTo3Mu]
   Float_t         TauTo3Mu_PVrefit_y[10];   //[nTauTo3Mu]
   Float_t         TauTo3Mu_PVrefit_z[10];   //[nTauTo3Mu]
   ...
   Float_t         TauTo3Mu_absIsolation_pT05[10];   //[nTauTo3Mu]
   ...
   Float_t         TauTo3Mu_errLxy_3muVtxBS[10];   //[nTauTo3Mu]
   Float_t         TauTo3Mu_fitted_eta[10];   //[nTauTo3Mu]
   Float_t         TauTo3Mu_fitted_mass[10];   //[nTauTo3Mu]
   Float_t         TauTo3Mu_fitted_mass_err2[10];   //[nTauTo3Mu]
   Float_t         TauTo3Mu_fitted_phi[10];   //[nTauTo3Mu]
   Float_t         TauTo3Mu_fitted_pt[10];   //[nTauTo3Mu]
   Float_t         TauTo3Mu_iso_ptChargedForHLT[10];   //[nTauTo3Mu]
   Float_t         TauTo3Mu_iso_ptChargedForHLT_pT05[10];   //[nTauTo3Mu]
   Float_t         TauTo3Mu_iso_ptChargedFromPU[10];   //[nTauTo3Mu]
   Float_t         TauTo3Mu_iso_ptChargedFromPU_pT05[10];   //[nTauTo3Mu]
   Float_t         TauTo3Mu_iso_ptChargedFromPV[10];   //[nTauTo3Mu]
   Float_t         TauTo3Mu_iso_ptChargedFromPV_pT05[10];   //[nTauTo3Mu]
   Float_t         TauTo3Mu_iso_ptPhotons[10];   //[nTauTo3Mu]
   Float_t         TauTo3Mu_iso_ptPhotons_pT05[10];   //[nTauTo3Mu]
   Float_t         TauTo3Mu_mu12_DCA[10];   //[nTauTo3Mu]
   Float_t         TauTo3Mu_mu12_fit_mass[10];   //[nTauTo3Mu]
   Float_t         TauTo3Mu_mu12_vtxFitProb[10];   //[nTauTo3Mu]
   Float_t         TauTo3Mu_mu13_DCA[10];   //[nTauTo3Mu]
   Float_t         TauTo3Mu_mu13_fit_mass[10];   //[nTauTo3Mu]
   Float_t         TauTo3Mu_mu13_vtxFitProb[10];   //[nTauTo3Mu]
   ...
   Float_t         TauTo3Mu_mu23_DCA[10];   //[nTauTo3Mu]
   Float_t         TauTo3Mu_mu23_fit_mass[10];   //[nTauTo3Mu]
   Float_t         TauTo3Mu_mu23_vtxFitProb[10];   //[nTauTo3Mu]
   ...
   Float_t         TauPlusMET_Deep_eta_max[10];   //[nTauPlusMET]
   Float_t         TauPlusMET_Deep_eta_min[10];   //[nTauPlusMET]
   Float_t         TauPlusMET_Deep_mass_max[10];   //[nTauPlusMET]
   Float_t         TauPlusMET_Deep_mass_min[10];   //[nTauPlusMET]
   ...
   Float_t         TauPlusMET_Puppi_eta_max[10];   //[nTauPlusMET]
   Float_t         TauPlusMET_Puppi_eta_min[10];   //[nTauPlusMET]
   Float_t         TauPlusMET_Puppi_mass_max[10];   //[nTauPlusMET]
   Float_t         TauPlusMET_Puppi_mass_min[10];   //[nTauPlusMET]
   ...
   Float_t         TauPlusMET_eta_max[10];   //[nTauPlusMET]
   Float_t         TauPlusMET_eta_min[10];   //[nTauPlusMET]
   Float_t         TauPlusMET_mass_max[10];   //[nTauPlusMET]
   Float_t         TauPlusMET_mass_min[10];   //[nTauPlusMET]
   Float_t         TauPlusMET_mass_nominal[10];   //[nTauPlusMET]
...
// used to generate this class and read the Tree.
   if (tree == 0) {
      TFile *f = (TFile*)gROOT->GetListOfFiles()->FindObject("root://xrootd-cms.infn.it//store/user/crovelli/ParkingDoubleMuonLowMass0/crab_data_Run2022Fv1_0/231212_221018/0000/tau3muNANO_data_2023Dec12_19.root");
      if (!f || !f->IsOpen()) {
         f = new TFile("root://xrootd-cms.infn.it//store/user/crovelli/ParkingDoubleMuonLowMass0/crab_data_Run2022Fv1_0/231212_221018/0000/tau3muNANO_data_2023Dec12_19.root");
      }
