...
// Thu Dec 14 11:01:45 2023 by ROOT version 6.24/07
// from TTree Events/Events
// found on file: /eos/cms/store/group/phys_bphys/cbasile/Tau3MuNano2022_2023Dec13/WtoTauNu_Tauto3Mu_TuneCP5_13p6TeV_pythia8/crab_WnuTau3Mu_2022EE/231213_093736/0000/tau3muNANO_mc_2023Dec13_12.root
//////////////////////////////////////////////////////////
...
// Fixed size dimensions of array or collections stored in the TTree if any.
   ...
   Int_t           nGenPart;
   Short_t         GenPart_genPartIdxMother[50];   //[nGenPart]
   UShort_t        GenPart_statusFlags[50];   //[nGenPart]
   ...
   Int_t           nTrigObj;
   Int_t           TrigObj_id[15];   //[nTrigObj]
   Float_t         TrigObj_pt[15];   //[nTrigObj]
   Float_t         TrigObj_eta[15];   //[nTrigObj]
   Float_t         TrigObj_phi[15];   //[nTrigObj]
   Int_t           nOtherPV;
...
// used to generate this class and read the Tree.
   if (tree == 0) {
      TFile *f = (TFile*)gROOT->GetListOfFiles()->FindObject("/eos/cms/store/group/phys_bphys/cbasile/Tau3MuNano2022_2023Dec13/WtoTauNu_Tauto3Mu_TuneCP5_13p6TeV_pythia8/crab_WnuTau3Mu_2022EE/231213_093736/0000/tau3muNANO_mc_2023Dec13_12.root");
      if (!f || !f->IsOpen()) {
         f = new TFile("/eos/cms/store/group/phys_bphys/cbasile/Tau3MuNano2022_2023Dec13/WtoTauNu_Tauto3Mu_TuneCP5_13p6TeV_pythia8/crab_WnuTau3Mu_2022EE/231213_093736/0000/tau3muNANO_mc_2023Dec13_12.root");
      }
