...
def main():
    ...
    # --defaults
    executable = './bin/RecoLevelAnalysis'
    ...
    jobdir = opt.prefix+'/RecoLevel_'+dataset+'_'+ now.strftime("%Y%m%d_%H%M%S")
    ...
    # for ijob, file_dat in enumerate(L):
        ...
        rootoutputfile =  outdirtmp+"recoKinematicsT3m_"+ job_tag + ".root"  #dataset+'_'+str(ijob)+'_RecoLevel'
        blind_tag = '_blind'
