#!/bin/bash
COMBINEDIR=$WORK/Combine-v10/CMSSW_14_1_0_pre4/src/tau3murun3_combination/Wchannel/unblind/ANv9_invID-mu2mu3_bin/datacards
PLOTOUT=$WORK/Combine-v10/CMSSW_14_1_0_pre4/src/tau3murun3_combination/Wchannel/unblind/ANv9_invID-mu2mu3_bin/plots
TAG=invID-mu2mu3
UNBLIND="--unblind"
#FIXPDF="--fixBestPdf"
