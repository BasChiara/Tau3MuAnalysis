#!/bin/bash
TAG=ANv11
COMBINEDIR=$WORK/Combine-v10/CMSSW_14_1_0_pre4/src/tau3murun3_combination/Wchannel/unblind/${TAG}/datacards
PLOTOUT=$WORK/Combine-v10/CMSSW_14_1_0_pre4/src/tau3murun3_combination/Wchannel/unblind/${TAG}/plots
