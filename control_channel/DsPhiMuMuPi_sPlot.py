...
dspl_val = ROOT.RooRealVar('Ds_Lxy_val_BS', ''  , 0.0,  np.inf, 'cm')
dspl_err = ROOT.RooRealVar('Ds_Lxy_err_BS', ''  , 0.0,  np.inf, 'cm')
sv_prob  = ROOT.RooRealVar('tau_fit_vprob', ''  , 0.0,  1.0)
phi_mass = ROOT.RooRealVar('phi_fit_mass', ''  , 0.5,  2.0, 'GeV')
var_list.append(dspl_sig)
var_list.append(dspl_val)
var_list.append(dspl_err)
