...
apply_reweighting('bdt_score', 
                  h_ratio_Lxy, weight_by='Ds_Lxy_err_BS',
                  nbins=25, lo=0, hi=1, 
                  selection=base_selection, 
                  add_tag=f'{args.tag}_byLxyErr')
...
for obs in observable_list:
    ...
    # apply reweighting by Lxy sigma
    apply_reweighting(obs, h_ratio_Lxy,
                      weight_by='Ds_Lxy_err_BS',
                      nbins   = cfg.features_NbinsXloXhiLabelLog[obs][0],
                      lo      = cfg.features_NbinsXloXhiLabelLog[obs][1],
                      hi      = cfg.features_NbinsXloXhiLabelLog[obs][2],
                      selection = base_selection,
                      to_ploton = [],
                      add_tag = tag +'_byLxyErr',
    )
