...
// Thu Nov 21 16:33:31 2024 by ROOT version 6.26/11
// from TTree Events/Events
// found on file: root://cms-xrd-global.cern.ch//store/mc/RunIISummer16NanoAODv7/DYJetsToLL_M-50_TuneCUETP8M1_13TeV-amcatnloFXFX-pythia8/NANOAODSIM/PUMoriond17_Nano02Apr2020_102X_mcRun2_asymptotic_v8_ext2-v1/270000/234F3D0C-7772-4445-9DC4-A6B09B308ED5.root
//////////////////////////////////////////////////////////

#ifndef GenLevel_base_h
#define GenLevel_base_h
...
// Fixed size dimensions of array or collections stored in the TTree if any.
   ...
   GenLevel_base(TTree *tree=0);
   virtual ~GenLevel_base();
...
#ifdef GenLevel_base_cxx
GenLevel_base::GenLevel_base(TTree *tree) : fChain(0) 
{
// if parameter tree is not specified (or zero), connect the file
// used to generate this class and read the Tree.
   if (tree == 0) {
      TFile *f = (TFile*)gROOT->GetListOfFiles()->FindObject("root://cms-xrd-global.cern.ch//store/mc/RunIISummer16NanoAODv7/DYJetsToLL_M-50_TuneCUETP8M1_13TeV-amcatnloFXFX-pythia8/NANOAODSIM/PUMoriond17_Nano02Apr2020_102X_mcRun2_asymptotic_v8_ext2-v1/270000/234F3D0C-7772-4445-9DC4-A6B09B308ED5.root");
      if (!f || !f->IsOpen()) {
         f = new TFile("root://cms-xrd-global.cern.ch//store/mc/RunIISummer16NanoAODv7/DYJetsToLL_M-50_TuneCUETP8M1_13TeV-amcatnloFXFX-pythia8/NANOAODSIM/PUMoriond17_Nano02Apr2020_102X_mcRun2_asymptotic_v8_ext2-v1/270000/234F3D0C-7772-4445-9DC4-A6B09B308ED5.root");
      }
...
GenLevel_base::~GenLevel_base()
{
   if (!fChain) return;
   delete fChain->GetCurrentFile();
}

Int_t GenLevel_base::GetEntry(Long64_t entry)
{
// Read contents of entry.
   if (!fChain) return 0;
   return fChain->GetEntry(entry);
}
Long64_t GenLevel_base::LoadTree(Long64_t entry)
{
...
void GenLevel_base::Init(TTree *tree)
{
...
void GenLevel_base::Show(Long64_t entry)
{
...
Int_t GenLevel_base::Cut(Long64_t entry)
{
