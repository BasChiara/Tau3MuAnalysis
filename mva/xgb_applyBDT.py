...
parser.add_argument('--tag',            default= 'emulateRun2',                                         help='tag to the training, will be used in the output file name. XGBout_[process]_[MC/DATA]_[tag].root')
parser.add_argument('--debug',          action = 'store_true' ,                                         help='set it to have useful printout')
parser.add_argument('--save_output',    action = 'store_true' ,                                         help='set it to save the bdt output')
parser.add_argument('--process',        choices= ['WTau3Mu', 'W3MuNu', 'data', 'DsPhiMuMuPi', 'peakingBkg', 'ZTau3Mu', 'invMedID'],   help='what process is in the input sample')
